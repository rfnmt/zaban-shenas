    ...
    <>
      <div className="feedback">
        ...
        >
          ...
          />
          <Typography sx={{ color: dark }}>میکروفون خاموش شد</Typography>
          <Icon width={24} height={24} icon="mic-off" />
        </Box>
        <div className="feedback-description">
          <Typography sx={{ color: "gray.3" }}>
            !تمرین‌های گفتاری تا آخر این جلسه رد خواهند شد
          </Typography>
        </div>
      </div>
      <Button
        onClick={() => skipQuestion("speaking")}
        variant="contained"
...
export default SpeakingPostponed;
